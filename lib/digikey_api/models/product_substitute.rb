...
module DigiKey
  ...
  class ProductSubstitute
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'SubstituteType')
        self.substitute_type = attributes[:'SubstituteType']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          substitute_type == o.substitute_type &&
    ...
    def hash
      [substitute_type, product_url, description, manufacturer, manufacturer_product_number, unit_price, quantity_available].hash
    end
