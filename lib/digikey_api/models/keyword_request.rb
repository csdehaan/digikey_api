...
module DigiKey
  ...
  class KeywordRequest
    ...
    attr_accessor :filter_options_request
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'FilterOptionsRequest')
        self.filter_options_request = attributes[:'FilterOptionsRequest']
      end

      if attributes.has_key?(:'SortOptions')
        self.sort_options = attributes[:'SortOptions']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          limit == o.limit &&
          offset == o.offset &&
          filter_options_request == o.filter_options_request &&
          sort_options == o.sort_options
    end
    ...
    def hash
      [keywords, limit, offset, filter_options_request, sort_options].hash
    end
