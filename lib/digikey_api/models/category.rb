...
module DigiKey
  # Categories are used to filter results of a given search  Example: When searching for batteries a category filter can be used to limit the search to rechargeable batteries
  class Category
    # CategoryId
    ...
    def hash
      [category_id, parent_id, name, product_count, children].hash
    end
