...
module DigiKey
  ...
  class PriceBreak
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'BreakQuantity')
        self.break_quantity = attributes[:'BreakQuantity']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          break_quantity == o.break_quantity &&
    ...
    def hash
      [break_quantity, unit_price, total_price].hash
    end
