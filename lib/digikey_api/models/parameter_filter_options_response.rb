...
module DigiKey
  ...
  class ParameterFilterOptionsResponse
    ...
    def self.swagger_types
      {
        ...
        :'filter_values' => :'Array<FilterValue>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'FilterValues')
        if (value = attributes[:'FilterValues']).is_a?(Array)
    ...
    def hash
      [category, parameter_type, parameter_id, parameter_name, filter_values].hash
    end
