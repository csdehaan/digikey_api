...
module DigiKey
  ...
  class Classifications
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ReachStatus')
        self.reach_status = attributes[:'ReachStatus']
      end
    ...
    def hash
      [reach_status, rohs_status, moisture_sensitivity_level, export_control_class_number, htsus_code].hash
    end
