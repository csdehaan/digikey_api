...
module DigiKey
  ...
  class SortOptions
    ...
    def valid?
      field_validator = EnumAttributeValidator.new('String', ['None', 'Packaging', 'ProductStatus', 'DigiKeyProductNumber', 'ManufacturerProductNumber', 'Manufacturer', 'MinimumQuantity', 'QuantityAvailable', 'Price', 'Supplier', 'PriceManufacturerStandardPackage'])
      return false unless field_validator.valid?(@field)
      sort_order_validator = EnumAttributeValidator.new('String', ['Ascending', 'Descending'])
    ...
    def field=(field)
      validator = EnumAttributeValidator.new('String', ['None', 'Packaging', 'ProductStatus', 'DigiKeyProductNumber', 'ManufacturerProductNumber', 'Manufacturer', 'MinimumQuantity', 'QuantityAvailable', 'Price', 'Supplier', 'PriceManufacturerStandardPackage'])
